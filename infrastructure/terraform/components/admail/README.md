...
| <a name="input_component"></a> [component](#input\_component) | The variable encapsulating the name of this component | `string` | `"admail"` | no |
...
| <a name="module_example_image_lambda"></a> [example\_image\_lambda](#module\_example\_image\_lambda) | https://github.com/NHSDigital/nhs-notify-shared-modules/releases/download/v2.0.32/terraform-lambda.zip | n/a |
