...
export const baseJestConfig: Config = {
  ...
  // Allow bare `src/...` imports to resolve from the project root, mirroring
  // the esbuild / TypeScript baseUrl behaviour at runtime.
  modulePaths: ["<rootDir>"],
  ...
  moduleNameMapper: {
    "\\.txt$": "<rootDir>/src/__mocks__/text-file.ts",
  },
